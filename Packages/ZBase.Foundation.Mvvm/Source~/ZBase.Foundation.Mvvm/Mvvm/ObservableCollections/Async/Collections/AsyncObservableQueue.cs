...
{
    public class AsyncObservableQueue<T> : IAsyncObservableCollection<T>
    {
        ...
        public AsyncObservableQueue(IEnumerable<T> collection)
        {
            _collection = new(collection);
        }

        public AsyncObservableQueue(int capacity)
        {
