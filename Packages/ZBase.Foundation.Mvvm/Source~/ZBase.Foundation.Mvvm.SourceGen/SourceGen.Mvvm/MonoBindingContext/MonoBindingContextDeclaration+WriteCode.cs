...
namespace ZBase.Foundation.Mvvm.MonoBindingContextSourceGen
{
    ...
    {
        private const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"ZBase.Foundation.Mvvm.MonoBindingContextGenerator\", \"1.2.0\")]";
        ...
        public string WriteCode()
        {
            ...
            p.OpenScope();
            {
                ...
                p.OpenScope();
                {
                    ...
                    p.OpenScope();
                    {
                        p.PrintLine("var comp = global::UnityEditor.Undo.AddComponent<global::ZBase.Foundation.Mvvm.Unity.ViewBinding.MonoBindingContext>(target.gameObject);");
