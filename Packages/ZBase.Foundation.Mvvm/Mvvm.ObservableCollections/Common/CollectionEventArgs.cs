...
namespace ZBase.Foundation.Mvvm.ObservableCollections
{
    public readonly struct CollectionEventArgs<T>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> Insert(IObservableCollection<T> sender, int index, T item)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.Insert, item, index);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> InsertRange(IObservableCollection<T> sender, int index, IEnumerable<T> items)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.InsertRange, index: index, items: items);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> AddRange(IObservableCollection<T> sender, IEnumerable<T> items)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.AddRange, items: items);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> Remove(IObservableCollection<T> sender, T item)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.Remove, item);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> RemoveRange(IObservableCollection<T> sender, IEnumerable<T> items)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.RemoveRange, items: items);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> RemoveAt(IObservableCollection<T> sender, int index)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.RemoveAt, index: index);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> RemoveRangeAt(IObservableCollection<T> sender, int index, int count)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.RemoveAt, index: index, count: count);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> Replace(IObservableCollection<T> sender, T item)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.Replace, item);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> ReplaceAt(IObservableCollection<T> sender, int index, T item)
        {
            return new CollectionEventArgs<T>(sender, CollectionAction.ReplaceAt, item, index: index);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CollectionEventArgs<T> Clear(IObservableCollection<T> sender)
        {
